(function() {
    ...
    define("pilot-block/test-web/block-test.js", function(require, module, exports, __dirname, __filename) {
        ...
        describe("block", function() {
            ...
            it("can scan for comment blocks", function() {
                $b.html(require("pilot-block/test-web/helpers/html/manyComments.js"));
                binder.update(b);
            });
    ...
    define("pilot-block/test-web/helpers/html/manyComments.js", function(require, module, exports, __dirname, __filename) {
        module.exports = '      <!--spc:5divs-->      <div id="1">            <!--spc:2ps-->        <p id="11">           </p>                  <p id="12">           </p>                  <!--epc:2ps-->      </div>                <div id="2">          </div>                <div id="3">          </div>                <div id="4">          </div>                <div id="5">          </div>                <!--epc:5divs-->      <!--spc:3spans-->     <span id="6">         </span>               <span id="7">         </span>               <span id="8">         </span>               <!--epc:3spans-->   '.replace(/[\n\t]+/g, "").replace(/\>\s+\</g, "><");
        return module.exports;
    });
    ...
    var entries = [ "pilot-block/test-web/block-test.js" ];
