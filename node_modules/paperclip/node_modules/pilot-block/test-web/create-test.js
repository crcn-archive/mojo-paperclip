(function() {
    ...
    define("pilot-block/test-web/create-test.js", function(require, module, exports, __dirname, __filename) {
        ...
        describe("create", function() {
            ...
            it("can scan for comment blocks", function() {
                b.innerHTML = require("pilot-block/test-web/helpers/html/noComments.js");
                binder.update(b);
            });
    ...
    define("pilot-block/test-web/helpers/html/noComments.js", function(require, module, exports, __dirname, __filename) {
        module.exports = '      <div id="1">            <p id="11">           </p>                  <p id="12">           </p>                </div>              '.replace(/[\n\t\r]+/g, "").replace(/\>\s+\</g, "><").replace(/\s+/g, " ").replace(/^\s+/, "").replace(/\s+$/, "");
        return module.exports;
    });
    ...
    var entries = [ "pilot-block/test-web/create-test.js" ];
